...
bool RegistrationCovariancePointToPoint3D<PointT>::computeRegistrationCovariance(const pcl::PointCloud<PointT>& reference_cloud_correspondences, const pcl::PointCloud<PointT>& ambient_cloud_orrespondences,
	...
	double correction_yaw = atan2f(registration_corrections(2, 1), registration_corrections(2, 2));
	double correction_pitch = asinf(-registration_corrections(2, 0));
	double correction_roll = atan2f(registration_corrections(1, 0), registration_corrections(0, 0));
