...
class IterativeClosestPointNonLinearTimeConstrained: public pcl::IterativeClosestPointNonLinear<PointSource, PointTarget, Scalar> {
	public:
		using Ptr = std::shared_ptr< IterativeClosestPointNonLinearTimeConstrained<PointSource, PointTarget, Scalar> >;
		using ConstPtr = std::shared_ptr< const IterativeClosestPointNonLinearTimeConstrained<PointSource, PointTarget, Scalar> >;
...
class IterativeClosestPointNonLinear : public IterativeClosestPoint<PointT> {
	...
	public:
		// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>   <usings>   <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
		using Ptr = std::shared_ptr< IterativeClosestPointNonLinear<PointT> >;
		using ConstPtr = std::shared_ptr< const IterativeClosestPointNonLinear<PointT> >;
		// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>   </usings>  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
